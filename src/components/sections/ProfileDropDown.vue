<template>
  <div class="group relative inline-block" v-if="user">
    <button
      class="inline-flex items-center rounded bg-gray-300 py-2 px-4 font-semibold text-gray-700"
    >
    ...
    <ul
      class="absolute hidden w-full pt-1 font-bold text-gray-700 group-hover:block"
    >
      <li class="">
        <router-link
        ...
        >
          <span
            ><font-awesome-icon :icon="['fas', 'user']" class="left"
          /></span>
      ...
      <li class="">
        ...
        >
          <span
            ><font-awesome-icon :icon="['fas', 'cogs']" class="left"
          /></span>
      ...
      <li class="">
        ...
        >
          <span
            ><font-awesome-icon :icon="['fas', 'circle-xmark']" class="left"
          /></span>
