        ...
        >
          ...
          >
            <NavButton
              ...
              bg-color="bg-white"
              bg-hover-color="hover:bg-gray-200"
            />
            <NavButton
              v-if="!user"
              ...
              bg-hover-color="hover:bg-indigo-800"
            />
          </div>
          <ProfileDropDown />
        </div>
...
<script>
import BrandLink from "@/components/links/BrandLink";
...
export default {
  name: "NavigationView",
  components: { ProfileDropDown, NavButton, NavLink, BrandLink },
