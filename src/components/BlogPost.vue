  ...
  <div class="blog-wrapper no-user">
    <div class="blog-content">
      <div>
        ...
        <router-link class="link link-light" v-if="post.welcomeScreen" :to="{ name: 'about-view' }"> Login/Register </router-link>
        <router-link class="link link-light" :to="{ name: 'about-view' }" v-else> View the Post </router-link>
      </div>
    </div>
